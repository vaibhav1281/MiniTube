...
const Header = () => {
    ...
    return (
        <header className='w-full h-20 dark:text-white select-none flex justify-center items-center top-0 sticky z-10 bg-white dark:bg-gray-950'>
            <div className='w-11/12 justify-center items-center flex space-x-8'>

                <button onClick={toggleMenuButton}  className='dark:bg-gray-900 hover:bg-black/10 dark:hover:bg-gray-700 p-2 rounded-full'>
                ...
                >
                     {theme === 'light' ? (
                        ...
                        <div className='dark:bg-gray-900 bg-black/10 dark:hover:bg-gray-700 p-2 rounded-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
